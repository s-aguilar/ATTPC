...
def convexHull(thresh, debug_mode = 0):
    ...
    if debug_mode:
        ...
        ax = sns.heatmap(thresh, xticklabels=30, yticklabels=30) ######################################### thresh[::-1]
        #ax.invert_yaxis()
        #plt.invert_yaxis()
        #plt.show()
    ...
    if debug_mode:
        ...
        plt.scatter(gpc[0][:,0,0],gpc[0][:,0,1],s=2)
        #plt.show()
...
def TipFinder(thresh, debug_mode = 0):
    ...
    if debug_mode:
        plt.title("Tipfinder")
        plt.scatter(hull[[bA,bB,bC],0,0],hull[[bA,bB,bC],0,1],marker='*', s=400,c='g')
        plt.show()
